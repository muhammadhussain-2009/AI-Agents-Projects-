try:
    ...
    # Fallback if crewai_tools is not available in the environment
    class BaseTool:  # minimal stand-in for type checks/compatibility
        pass
import ast
import operator
import re
    ...
    def _run(self, operation: str) -> float:
        try:
            ...
            if not isinstance(result, (int, float)):
                raise ValueError("Invalid result type from mathematical expression")
            return float(result)
